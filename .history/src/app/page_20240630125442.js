...
const MenuToggle = ({ toggle, isOpen }) => (
  <button
    onClick={toggle}
    className={`fixed top-2 w-12 h-12 rounded-full p-3 focus:outline-none bg-[#f8dbc5] z-50 transition-all duration-1000 ${
      ...
      <AnimatePresence>
        {isOpen && (
          <>
            ...
            />
            <motion.nav
              className="fixed top-0 right-0 bottom-0 w-64 bg-[#f8dbc5] pt-24 z-50"
              initial={{ x: "100%" }}
              animate={{ x: 0 }}
              exit={{ x: "100%" }}
