  ...
  return (
    ...
    >
      {!videoError ? (
        ...
        >
          <source src="https://srv815-files.hstgr.io/4046988dc9a98286/files/public_html/talita/wp-content/uploads/2024/02/lash_art.mp4" type="video/mp4" />
          Seu navegador não suporta a tag de vídeo.
        </video>
      ) : (
        <img 
          src="https://talita.conectando.site/wp-content/uploads/2024/02/Thalita-Cristina-7.png" 
      ...
      <motion.div 
        ...
        className="relative z-10 text-center p-8 bg-white bg-opacity-80 rounded-lg shadow-xl"
      >
