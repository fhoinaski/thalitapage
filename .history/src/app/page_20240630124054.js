      ...
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <div className="md:hidden">
          <button onClick={toggleMenu} className="text-primary">
            <Menu size={24} color={colors.terciary} />
          </button>
        </div>
      </div>
      <AnimatePresence>
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed top-0 right-0 h-full w-full sm:w-64 bg-white shadow-lg z-50"
            >
              <div className="p-5 flex justify-end">
                <button onClick={toggleMenu} className="text-terciary">
                  <X size={24} />
                </button>
              </div>
              <ul className="p-10 gap-10 ">
                {menuItems.map((item) => (
                  <motion.li
                    key={item}
                  ...
                  >
                    <a
                      href={`#${item.toLowerCase()}`}
                      className="text-lg uppercase tracking-wider transition-colors duration-300 "
