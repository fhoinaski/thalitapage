...
const MenuToggle = ({ toggle, isOpen }) => (
  <button
    onClick={toggle}
    className={`fixed top-2 w-12 h-12 rounded-full p-3 focus:outline-none bg- z-50 transition-all duration-1000 ${
...
const Header = () => {
  ...
  return (
    ...
    >
      ...
      <div className={`md:hidden fixed top-2 ${isOpen ? 'right-[74px]' : 'right-46'} transition-all duration-300`}>
