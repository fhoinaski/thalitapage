...
const Header = () => (
  ...
  >
    <div className="container mx-auto px-4 py-4 flex justify-between items-center">
      <h1 className="text-2xl md:text-3xl font-serif font-bold" style={{ color: colors.primary }}>
        Thalita Cristina
      </h1>
...
const Hero = () => (
  <motion.section 
    ...
    className="min-h-screen flex items-center justify-center bg-cover bg-center bg-no-repeat bg-opacity-80 bg-fixed"
    style={{ 
      backgroundImage: "url('https://talita.conectando.site/wp-content/uploads/2024/02/Thalita-Cristina-7.png')", 
  ...
  >
    <motion.div 
      ...
      className="text-center p-8 bg- bg-opacity-80 rounded-lg "
    >
