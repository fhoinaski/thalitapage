  ...
  <header className="bg-pink-100 p-4 flex justify-between items-center">
    ...
    <nav>
      <ul className="flex space-x-4">
        <li>
          <a href="#about" className="text-pink-800 hover:text-pink-600">
            Sobre
          </a>
        </li>
        <li>
          <a href="#services" className="text-pink-800 hover:text-pink-600">
            Serviços
          </a>
        </li>
        <li>
          <a href="#contact" className="text-pink-800 hover:text-pink-600">
            Contato
          </a>
        </li>
      </ul>
...
const Hero = () => (
  ...
  >
    <h2 className="text-4xl font-bold text-pink-800 mb-4">
      Bem-vinda ao Olhar Perfeito
    </h2>
    <p className="text-xl text-pink-700">
      Descubra a beleza dos seus olhos com Thalita Cristina
    </p>
  </motion.section>
);
  ...
  >
    <div className="container mx-auto px-4">
      ...
      <p className="text-lg text-pink-700">
        Thalita Cristina é especialista no embelezamento do olhar. Nosso estúdio
        oferece um espaço aconchegante e procedimentos de excelência para
        realçar sua beleza natural e aumentar sua autoestima.
      </p>
    </div>
  </motion.section>
);
...
const Testimonials = () => {
  const testimonials = [
    ...
    {
      name: "Carla",
      text: "Minha autoestima melhorou muito após o procedimento.",
    },
  ];
      ...
      <div className="flex flex-col md:flex-row justify-between items-start">
        <div className="mb-6 md:mb-0">
          ...
          <p className="text-pink-700 flex items-center">
            ...
            Rua Patrício Farias, 55, Vitória Eco Office sala 409, Florianópolis/
            Itacorubi
          </p>
        </div>
        <div>
